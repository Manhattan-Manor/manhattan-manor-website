...
const AdminHome: React.FC = () => {
    const [activeComponent, setActiveComponent] = useState<'tickets' | 'giftcards' | null>(() => {
        const storedComponent = sessionStorage.getItem('activeComponent') || 'tickets';
    ...
    return (
        <div style={styles.container}>
            <div style={styles.navbar}>
                <a
                    href="#"
                    style={activeComponent === 'tickets' ? styles.navButtonSelected : styles.navButton}
                ...
                <a
                    href="#"
                    style={activeComponent === 'giftcards' ? styles.navButtonSelected : styles.navButton}
